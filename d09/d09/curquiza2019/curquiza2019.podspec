...
- delete
  ...
  s.resource_bundles = {'curquiza2019' => ['curquiza2019/**/*.xcdatamodeld']}
  # s.resources = 'curquiza2019/**/*.xcdatamodeld'
  s.source_files = 'curquiza2019/Classes/*.swift'
  # s.resources = 'curquiza2019/Classes/*.xcdatamodeld'
